...
public class Proyectos {
	...
	public Proyectos(String nombre, Integer codigoProyecto, List<String> palabrasClave, List<Double> localizacion,
			...
			String pdf, String imagen, List<String> preguntas, List<List<String>> respuestas) {
		super();
		this.nombre = nombre;
	...
	public List<List<String>> getRespuestas() {
		return respuestas;
	}

	public void setRespuestas(List<List<String>> respuestas) {
		this.respuestas = respuestas;
	}
