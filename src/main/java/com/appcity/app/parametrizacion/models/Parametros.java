package com.appcity.app.parametrizacion.models;
...
public class Parametros {
	...
	private List<Integer> labelProyectos;
	...
	public Parametros(String username, List<Double> colorPrimario, List<Double> colorSecundario, String logotipo,
			...
			List<String> ubicacionMuro, List<Integer> labelProyectos, List<Integer> labelMuros) {
		super();
		...
		this.labelProyectos = labelProyectos;
	...
	public List<Integer> getLabelProyectos() {
		return labelProyectos;
	}

	public void setLabelProyectos(List<Integer> labelProyectos) {
		this.labelProyectos = labelProyectos;
	}
