package com.appcity.app.parametrizacion.controller;
...
import com.appcity.app.parametrizacion.clients.MuroFeignClient;
import com.appcity.app.parametrizacion.models.Proyectos;
import com.appcity.app.parametrizacion.models.Parametros;
import com.appcity.app.parametrizacion.repository.ParametrosRepository;
...
public class ParametroController {
	...
	public List<Integer> getLabelProyectos(){
		Parametros params = parametros.findByUsername("parameters");
		return params.getLabelProyectos();
	}
	
	@PutMapping("/parametros/editar/labelProyectos")
	@ResponseStatus(code = HttpStatus.OK)
	public Parametros editarLabelProyectos(@RequestBody Parametros parametro){
		Parametros param = parametros.findByUsername("parameters");
		param.setLabelProyectos(parametro.getLabelProyectos());
		return parametros.save(param);
	}
	
	@PutMapping("/parametros/editar/labelProyectosManejo")
	@ResponseStatus(code = HttpStatus.OK)
	public void editarLabelProyectosManejo(){
		Parametros param = parametros.findByUsername("parameters");
		Integer countProyecto = param.getLabelProyectos().size()+1;
		List<Integer> listaLabel = param.getLabelProyectos();
		listaLabel.add(countProyecto);
		param.setLabelProyectos(listaLabel);
		parametros.save(param);
	}
	
	@PutMapping("/parametros/editar/labelProyectosManejoDel/{number}")
	@ResponseStatus(code = HttpStatus.OK)
	public void editarLabelProyectosManejoDelete(@PathVariable Integer number){
		Parametros param = parametros.findByUsername("parameters");
		List<Integer> listaLabel = new ArrayList<Integer>();
	...
	@PutMapping("/parametros/error/codigoProyecto")
	@ResponseStatus(code = HttpStatus.OK)
	public String errorCodigoProyecto() {
		try {
			List<Proyectos> listaProyectos = muroFeign.getProyectos();
			Parametros param = parametros.findByUsername("parameters");
			List<Integer> listaLabel = new ArrayList<Integer>();
			...
			return "Microservicio Muro offline:  "+e.getMessage();
		}
	}
	...
	@ResponseStatus(code = HttpStatus.OK)
	public void editarLabelMurosManejo(){
		Parametros param = parametros.findByUsername("parameters");
	...
	public Parametros editar(@RequestBody Parametros parametro) {
		Parametros param = parametros.findByUsername("parameters");
		if(parametro.getColorPrimario() != null) param.setColorPrimario(parametro.getColorPrimario());
		if(parametro.getColorSecundario() != null) param.setColorSecundario(parametro.getColorSecundario());
		if(parametro.getLogotipo() != null) param.setLogotipo(parametro.getLogotipo());
		if(parametro.getImagenes() != null) param.setImagenes(parametro.getImagenes());
		if(parametro.getRepresentacionMuro() != null) param.setRepresentacionMuro(parametro.getRepresentacionMuro());
		if(parametro.getTituloLogin() != null) param.setTituloLogin(parametro.getTituloLogin());
		if(parametro.getTextoContenidoLogin() != null) param.setTituloLogin(parametro.getTituloLogin());
		if(parametro.getTextoBotonLogin() != null) param.setTextoBotonLogin(parametro.getTextoBotonLogin());
		if(parametro.getTituloOTP() != null) param.setTituloOTP(parametro.getTituloOTP());
		if(parametro.getTextoContenidoOTP() != null) param.setTextoContenidoOTP(parametro.getTextoContenidoOTP());
		if(parametro.getTextoBotonOTP() != null) param.setTextoBotonOTP(parametro.getTextoBotonOTP());
		if(parametro.getTituloRegistro() != null) param.setTituloRegistro(parametro.getTituloRegistro());
		if(parametro.getEntradasRegistro() != null) param.setEntradasRegistro(parametro.getEntradasRegistro());
		if(parametro.getTextoBotonesRegistro() != null) param.setTextoBotonesRegistro(parametro.getTextoBotonesRegistro());
		if(parametro.getTituloWrapWidgets() != null) param.setTituloWrapWidgets(parametro.getTituloWrapWidgets());
		if(parametro.getTextoContenidoWrapWidgets() != null) param.setTextoContenidoWrapWidgets(parametro.getTextoContenidoWrapWidgets());
		if(parametro.getTextoBotonesWrapWidgets() != null) param.setTextoBotonesWrapWidgets(parametro.getTextoBotonesWrapWidgets());
		if(parametro.getChipsWrapWidgets() != null) param.setChipsWrapWidgets(parametro.getChipsWrapWidgets());
		if(parametro.getTituloHomePage() != null) param.setTituloHomePage(parametro.getTituloHomePage());
		if(parametro.getTextoContenidoHomePage() != null) param.setTextoContenidoHomePage(parametro.getTextoContenidoHomePage());
		if(parametro.getIconosMenuHomePage() != null) param.setIconosMenuHomePage(parametro.getIconosMenuHomePage());
		if(parametro.getColorBotonesHomePage() != null) param.setColorBotonesHomePage(parametro.getColorBotonesHomePage());
		if(parametro.getColorNavegacionHomePage() != null) param.setColorNavegacionHomePage(parametro.getColorNavegacionHomePage());
		if(parametro.getIconosNavegacionHomePage() != null) param.setIconosNavegacionHomePage(parametro.getIconosNavegacionHomePage());
		if(parametro.getDestinoNavHomePage() != null) param.setDestinoNavHomePage(parametro.getDestinoNavHomePage());
		if(parametro.getTituloMapa() != null) param.setTituloMapa(parametro.getTituloMapa());
		if(parametro.getUbicacionMuro() != null) param.setUbicacionMuro(parametro.getUbicacionMuro());
		if(parametro.getLabelProyectos() != null) param.setLabelProyectos(parametro.getLabelProyectos());
		return parametros.save(param);
	}
